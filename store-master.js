...
var makeTable = function() {
	connection.query("SELECT * FROM products", function(err, res) {
		...
		// Print the table to the console with minimal styling
		var tab = "\t";
		console.log("ItemID\tProduxt Name\tDepartment Name\tPrice\t# In Stock");
		console.log("----------------------------------------------------------");
...
function addItem() {
  inquirer.prompt([
    ...
    function(err, res) {
      ...
      console.log("Item added to store-master!");
      makeTable();
    });
  });
}
